...
$listaProductos = $objControl->buscar(null);
?>
...
?>
<table id="dg" title="Administrador de item Producto" class="easyui-datagrid" style="width:1200px;height:500px"
    url="accion/listarproductos.php" toolbar="#toolbar" pagination="true"rownumbers="true" fitColumns="true" singleSelect="true">
            ...
            <th field="proimporte" width="20">Importe</th>
            <th field="proimagen" width="150">Ruta imagen</th>
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editUser()">Editar Producto</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="destroyUser()">Baja Producto</a>
            </div>
            ...
            <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px" enctype='multipart/form-data'>
                ...
                <div style="margin-bottom:10px">
                    <input name="proimagen" value="proimagen" value=null  style="display:none">
                </div>
        		<div>
            ...
            function editUser(){
                ...
                if (row){
                    ...
                    $('#fm').form('load',row);
                    url = 'accion/editarproducto.php?accion=mod&idproducto='+row.idproducto;
                }
            }
            function saveUser(){
                //alert(" Accion");
            ...
            function destroyUser(){
                ...
                if (row){
                    $.messager.confirm('Confirm','Seguro que desea eliminar el producto?', function(r){
                        if (r){
                            $.post('accion/bajaproducto.php?idproducto='+row.idproducto,{idproducto:row.id},
                               function(result){
                                 if (result.respuesta){
